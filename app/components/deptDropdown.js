          ...
          {toggled && (
            <>
              <label className="check-container">
                ...
                />{" "}
                <p className="category-text">Department 1</p>
              </label>
              ...
              <label className="check-container">
                <input
                  ...
                  onChange={handleDepartmentChange}
                />{" "}
                <p className="category-text">Department 2</p>
              </label>
              ...
              <label className="check-container">
                <input
                  ...
                  onChange={handleDepartmentChange}
                />{" "}
                <p className="category-text">Department 3</p>
              </label>
              ...
              <label className="check-container">
                <input
                  ...
                  onChange={handleDepartmentChange}
                />{" "}
                <p className="category-text">Department 4</p>
              </label>
            </>
          )}
        </div>
