...
{/*<a className="operation-button" onClick={toggleView}> Click Me
 {isLineView ? 'Click Me' : 'Switch to Line View'} 
</a>

{isLineView && (
    <div id="claim-list" className={isLineView ? 'line' : 'claim-list grid'}>
    <div className="claim-wrapper">
        <div className="status "><div></div>Open</div>
        <div className="title">Claim Title</div>
        <hr></hr>
